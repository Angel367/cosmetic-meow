...
urlpatterns = [
    path('my/courses/', MyCourseListView.as_view(), name='course'),
    ...
    path('my/courses/<int:course_id>/edit/', UpdateCourse.as_view(), name='course_edit'),
    path('courses/', CourseListView.as_view(), name='courses_all'),
    path('my/courses/add/', CreateCourse.as_view(), name='course_add_as_product'),
