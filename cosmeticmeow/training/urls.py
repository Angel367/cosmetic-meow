...
url_content = [
    ...
    path('tests/<int:lesson_id>/edit/', UpdateTest.as_view(), name='test_edit'),
    path('tests/add/', CreateTest.as_view(), name='test_add'),
]
url_lessons = [
    path('lessons/<int:lesson_id>/', include(url_content)),
    path('lessons/<int:lesson_id>/', LessonInfoView.as_view(), name='lesson_info'),
...
url_module = [
    ...
    path('modules/<int:module_id>/', ModuleInfoView.as_view(), name='module_info'),
...
urlpatterns = [
    path('my/courses/', MyCourseListView.as_view(), name='course_info'),
    path('my/courses/<int:course_id>/', include(url_module)),
