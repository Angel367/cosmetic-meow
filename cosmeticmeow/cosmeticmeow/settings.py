"""
Django's settings for cosmeticmeow project.
...
SECRET_KEY = 'django-insecure-fpkub%8**g_@kepk!!t6t^+aw!n^2o3d1prc6=8d_dnymn(p13'
...
ROOT_URLCONF = 'cosmeticmeow.urls'
...
WSGI_APPLICATION = 'cosmeticmeow.wsgi.application'
